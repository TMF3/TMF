...
if (GVAR(giveMissingRadios)) then {
    ...
    //TODO - Debug below is broken should work though.
    {
        ...
        private _groupCond = (_unitGroup get3DENAttribute "TMF_Network") param [0,-1];
        if (_groupCond == _radioPresetIdx) then { _passes = true; };
        private _unitCond = (_unit get3DENAttribute "TMF_Network") param [0,-1];
