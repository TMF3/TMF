...
#define TMF_GROUPBASE_W             (37.8 * TMF_ADMINMENU_STD_WIDTH)
#define TMF_GROUPBASE_H             (20.6 * TMF_ADMINMENU_STD_HEIGHT)
...
#define IDC_TMF_ADMINMENU_MSGS_LABEL        56602
#define TMF_ADMINMENU_W_LABEL               (2.1 * TMF_ADMINMENU_STD_WIDTH)
#define TMF_ADMINMENU_H_LABEL               (1 * TMF_ADMINMENU_STD_WIDTH)

#define IDC_TMF_ADMINMENU_MSGS_LIST         56603
#define TMF_ADMINMENU_MSGS_Y_LIST           (1.1 * TMF_ADMINMENU_STD_HEIGHT + (safezoneY + (safezoneH - (((safezoneW / safezoneH) min 1.2) / 1.2))/2))
#define TMF_ADMINMENU_MSGS_W_LIST           (TMF_GROUPBASE_W - 0.1 * TMF_ADMINMENU_STD_WIDTH)
#define TMF_ADMINMENU_MSGS_H_LIST           (TMF_GROUPBASE_H - 0.1 * TMF_ADMINMENU_STD_HEIGHT - 2 * TMF_ADMINMENU_MSGS_Y_LIST)

#define IDC_TMF_ADMINMENU_MSGS_COPY         56604
#define IDC_TMF_ADMINMENU_MSGS_COPYALL      56605
