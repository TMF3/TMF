...
#define IDC_TMF_ADMINMENU_PMAN_UPDATEFLASH 56319
...
// would be 4.4*stdwidth; extra .2 is for scrollbar
#define TMF_ADMINMENU_PMAN_W_LIST (TMF_ADMINMENU_PMAN_W_LISTGROUP - (4.6 * TMF_ADMINMENU_STD_WIDTH))
#define TMF_ADMINMENU_PMAN_X_DEAD 0
#define TMF_ADMINMENU_PMAN_X_SIDE (1.1 * TMF_ADMINMENU_STD_WIDTH)
