class baseMan {// Weaponless baseclass
    ...
    // Only include a single type of each magazine to load. Each magazine is applied to the weapon once.
    primaryMagazine[] = {};
    scope[] = {};
    bipod[] = {};
    attachment[] = {};
...
class r : baseMan
{
    ...
    magazines[] =
    {
        LIST_10("30Rnd_65x39_caseless_mag"),
